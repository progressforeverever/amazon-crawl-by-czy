...
cnt = 0     #计数器
url='https://www.amazon.com/Deaths-End-audiobook/product-reviews/B01LW7NVP0/ref=cm_cr_dp_d_show_all_btm?pageNumber='
url_list=[]
...
def parse_comment(task):
    ...
    global cnt
    with open("./DeathsEnd.txt",mode='a',encoding='utf-8') as f:
